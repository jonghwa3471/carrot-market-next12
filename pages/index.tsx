...
const Home: NextPage = () => {
  return (
    <div className="grid min-h-screen gap-10 bg-slate-400 px-20 py-20">
      <div className="rounded-3xl bg-white p-6 shadow-xl sm:bg-red-400 sm:hover:bg-pink-800 md:bg-teal-400 lg:bg-indigo-400 xl:bg-yellow-400 2xl:bg-pink-400">
        ...
        <button className="mx-auto mt-5 block w-1/2 rounded-xl bg-blue-500 p-3 text-center text-white hover:bg-teal-500 hover:text-black focus:bg-red-500 active:bg-yellow-500">
          Checkout
        </button>
      </div>
