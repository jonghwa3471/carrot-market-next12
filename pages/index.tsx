...
const Home: NextPage = () => {
  return (
    <div className="dark grid min-h-screen gap-10 bg-slate-400 px-20 py-20 lg:grid-cols-2 xl:grid-cols-3 xl:place-content-center">
      <div className="flex flex-col justify-between rounded-3xl bg-white p-6 shadow-xl dark:bg-black">
        ...
        <button className="mx-auto mt-5 block w-1/2 rounded-xl bg-blue-500 p-3 text-center text-white transition-colors hover:bg-teal-500 hover:text-black focus:bg-red-500 active:bg-yellow-500 dark:border dark:border-white dark:bg-black dark:hover:bg-white">
          Checkout
        </button>
      </div>
